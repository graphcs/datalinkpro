...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Remote Computer", "Other Device"),
        ("Local Computer", "This Device"),
        ...
        ("config_acc", "In order to use this application, you need to grant \"Accessibility\" permissions."),
        ("config_screen", "In order to use this application, you need to grant \"Screen Sharing\" permissions for database visualization."),
        ...
        ("android_new_connection_tip", "New database connection request has been received."),
        ...
        ("config_input", "In order to interact with the database interface, you need to grant \"Input Monitoring\" permissions."),
